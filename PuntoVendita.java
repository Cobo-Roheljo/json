...
public class PuntoVendita {
    ...
    public int getIdPuntiVendita() {
        return idPuntiVendita;
    }
    public void setIdPuntiVendita(int idPuntiVendita) {
        this.idPuntiVendita = idPuntiVendita;
    }
